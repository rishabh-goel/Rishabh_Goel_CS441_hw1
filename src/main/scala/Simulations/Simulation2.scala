...
object Simulation2 extends App {
  ...
  logger.info("Starting VM & Cloudlet SpaceShared Simulation Execution\n")
  val simulation = new CloudSim();

  logger.info("Extracting datacenter specifications for Simulation 2\n")
  ...
  // Create a datacenter for simulation with Simple VM Allocation Policy and Space Shared VM Scheduler
  cloudElements.createDatacenter(simulation, new VmAllocationPolicySimple, new VmSchedulerSpaceShared, true)
  ...
  val vm: List[Vm] = cloudElements.createVmList(new CloudletSchedulerSpaceShared)
  ...
  logger.info("Ending VM & Cloudlet SpaceShared Simulation Execution\n")
}
