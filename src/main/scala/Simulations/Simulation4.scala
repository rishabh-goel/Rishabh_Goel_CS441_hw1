...
object Simulation4 extends App {
  ...
  logger.info("Starting Best Fit VM Allocation Execution\n")
  val simulation = new CloudSim();

  logger.info("Extracting datacenter specifications for Simulation 5\n")
  ...
  // Create a datacenter for simulation with Best Fit VM Allocation Policy and Space Shared VM Scheduler
  cloudElements.createDatacenter(simulation, new VmAllocationPolicyBestFit, new VmSchedulerSpaceShared, true)
  ...
  logger.info("Creating list of Cloudlets")
  ...
  logger.info("Cloublets created & submitting to the broker")
  ...
  logger.info("Ending Best Fit Vm Execution Simulation\n\n")
}
